...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run baseline training pipeline (P_UT -> multipoles).")
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Physics trainer: weight on log-total-power amplitude vs observations.",
    )
...
def main() -> None:
    ...
    print("Baseline workflow finished.")
